...
import './SuaThuMoi.css';

const SuaThuMoi = ({ isOpen, onClose, entryData, onEditSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`https://song-dao-backend.onrender.com/thumoi/entry/${entryData.id}`, {
                method: 'PUT',
                body: formData,
            });
